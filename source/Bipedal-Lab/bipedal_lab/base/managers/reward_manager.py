...
class RewardManagerCfg:
    ...
    q_names: list = MISSING

    qpos_limit: list = MISSING
    
    qtau_limit: list = MISSING
...
class RewardManager:
    ...
    def __init__(self, cfg: RewardManagerCfg, env: DirectRLEnv, rdm: RobotDataManager):
        ...
        self.env = env
        self.rdm = rdm
        self.cfg_dict = self.cfg.to_dict()
